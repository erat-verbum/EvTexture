...
from src.basicsr.data.prefetch_dataloader import PrefetchDataLoader
from src.basicsr.utils import get_root_logger, scandir
from src.basicsr.utils.dist_util import get_dist_info
from src.basicsr.utils.registry import DATASET_REGISTRY
...
_dataset_modules = [
    importlib.import_module(f"src.basicsr.data.{file_name}")
